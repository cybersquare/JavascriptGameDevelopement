...
window.addEventListener("keydown", (e) => {
  var left = parseInt(window.getComputedStyle(cannon).getPropertyValue("left"));
  if (e.key == "ArrowLeft" && left > 0) {
    cannon.style.left = left - 10 + "px";
  }
  //460  =>  board width - cannon width
  ...
  if (e.key == "ArrowUp" || e.keyCode == 32) {
    ...
    var movebullet = setInterval(() => {
      ...
      bullet.style.left = left + "px"; //bullet should always be placed at the top of my cannon..!
